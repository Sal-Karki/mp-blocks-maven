...
public class Lines implements AsciiBlock {
  ...
  /**
   * Determine if this Lines block is structurally equivalent to another Lines block.
   *
   * @param other The Lines block to compare to this block.
   *
   * @return true if the two blocks are structurally equivalent and false otherwise.
   */
  public boolean eqv(Lines other) {
    ...
    for (int i = 0; i < this.height(); i++) {
      try {
        ...
        return false; // Row access failed
      } // try catch
    } // for
